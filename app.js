...
function main() {
    button.addEventListener('click', function() {
        const phrases = ["Your eyes (they say it all)", "Your long ass legs", "The way you laugh", "The way you smile", 
                        "The way you roast me", "The way you text with me (Englishhhh)", "Your chin", 
                        ...
                        "Your opinions", "That you are caring", "That you think about others", "The way you kiss", 
                        ...
                        "Your cute face", "Your personality", "Your traits", "Your lifestyle (I can flex with that)"];
